...
@mark.parametrize('code,stack_name,is_province,is_prefecture,is_county', [
    ('110101', '北京市/市辖区/东城区', False, False, True),
    ('110100', '北京市/市辖区', False, True, False),
    ('110000', '北京市', True, False, False),
])
...
@mark.parametrize('code,year,repr_result,unicode_result', [
    ('110101', None,
     "gb2260.get(u'110101')", '<GB2260 110101 北京市/市辖区/东城区>'),
    ('110100', None,
     "gb2260.get(u'110100')", '<GB2260 110100 北京市/市辖区>'),
    ('110000', None,
     "gb2260.get(u'110000')", '<GB2260 110000 北京市>'),
    ('110000', 2006,
     "gb2260.get(u'110000', 2006)", '<GB2260-2006 110000 北京市>'),
])
...
@mark.parametrize('code,year,repr_result,unicode_result', [
    ('110101', None,
     "gb2260.get('110101')", '<GB2260 110101 北京市/市辖区/东城区>'),
    ('110100', None,
     "gb2260.get('110100')", '<GB2260 110100 北京市/市辖区>'),
    ('110000', None,
     "gb2260.get('110000')", '<GB2260 110000 北京市>'),
    ('110000', 2006,
     "gb2260.get('110000', 2006)", '<GB2260-2006 110000 北京市>'),
])
